...
1. After the student have read all the information, pre-requisites for inscription he can fill the inscription form when is open.
   (From the system the Coordinator can enable or disable the inscription forms.)

![alt text](image.png)

2. The Student have to talk in person with the coordinator or the career director about their project to see if the project is okay about technologies and duplicity, but with the information provided there wont be any problem.

3. Then the student have to give them the proposition of the project in a letter, then the project has to be a accepted and also the director

From part of the Coordinator or career director, he have to accept your request:
![alt text](image-1.png)

And he can write any conditions for your case, for special cases and conditions of inscriptions:
![alt text](image-2.png)

The student receive their credentials: username and autogenerated password
![alt text](image-3.png)

4. After the student log in the system, he can now see the new tab "Mi propuesta de trabajo", there he can upload a link of drive of the photo or scan of the letter with stamp from the coordinator/career director
...
After sending the degree workshop proposal the Student can wait until the response of the meeting of the career director and executives in charge of the review of the proposals
...
1. First the Professor can send their email to the admin of the system and he/she have to write it down in the page "Create temporal code".
...
5. After login, He/She can edit their personal information, photo
   ![alt text](imgs/image-5.png)
   ![alt text](imgs/image-6.png)

6. He/She can add subjects to their information and write it down some experience about that, it'll be showed to the students that need a tutor for their thesis project
   ![alt text](imgs/image-7.png)

7. He/She can add a lnkedin link for more information for their students, also he can add multiple links if needed
