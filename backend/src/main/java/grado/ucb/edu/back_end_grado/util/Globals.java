...
public class Globals {
    ...
    public static final String reCaptchaSiteSecret = "asd";
    ...
    public static final String[] httpMethodNowAllowed = HttpStatus.METHOD_NOT_ALLOWED.toString().split(" "); // Status
                                                                                                             // 405
    public static final String[] httpInternalServerErrorStatus = HttpStatus.INTERNAL_SERVER_ERROR.toString().split(" "); // Status
                                                                                                                         // 500
