...
//
//    @PatchMapping
//    public ResponseEntity<Object> updateSocialNetworkInfo(@PathVariable Long userId, @RequestBody SocialNetworkUpdateRequest request) {
//        LOG.info("API called to update social network info for professor with ID: {}", userId);
//        try {
//            Object response = socialNetworkBl.updateSocialNetworkInfo(userId, request);
