...
@RestController
@RequestMapping(Globals.apiVersion + "professor/{professorId}/subjects/{subjectId}/comments")
public class CommentsApi {
    ...
    @PostMapping
    public ResponseEntity<Object> addComment(@PathVariable Long professorId, @PathVariable Long subjectId, @RequestBody CommentRequest request) {
        LOG.info("API called to add a new comment for professor ID: {}, subject ID: {}", professorId, subjectId);
        try {
            Object response = commentsBl.addComment(professorId, subjectId, request);
