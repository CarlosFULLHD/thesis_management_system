import {
    Card, CardFooter, CardHeader, Image, CircularProgress, Chip
                ...
                <CardFooter className="absolute bg-black/40 bottom-0 z-10 border-t-1 border-default-600 dark:border-default-100">
                    <div className="flex flex-grow gap-2 items-center">
                        ...
                        <div className="flex flex-col text-left">
                            <p className="text-tiny text-white/60">Fecha inicio: <b>{mainAcademicPeriod.initDate}</b></p>
                            <p className="text-tiny text-white/60">Fecha final: <b>{mainAcademicPeriod.endDate}</b></p>
                            <p className="text-tiny text-white/60">Inscripciones: <b>{mainAcademicPeriod.accountUntil}</b></p>
                        </div>
                    </div>
