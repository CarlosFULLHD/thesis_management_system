  ...
  return (
    <div>
      <Tooltip color="secondary" content="Ver detalles">
        <Button
          key="blur"
          className="bg-yellow-light font-bold dark:bg-yellow-dark dark:text-black"
          onPress={onOpen}
        >
          <FaRegListAlt />
        </Button>
      ...
      <Modal backdrop="blur" isOpen={isOpen} onOpenChange={onOpenChange}>
        <ModalContent>
          {(onClose) => (
            <>
              <ModalHeader className="flex flex-col gap-5 md:text-2xl">
