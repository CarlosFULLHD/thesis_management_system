...
import { TaskInterface, emptyTask, useTasks } from "../../providers/tasksProvider";
import { Accordion, AccordionItem, Button, Card, CardBody, CardFooter, CardHeader, Radio, Chip, CircularProgress, Divider, Link, RadioGroup, Textarea, Modal, ModalContent, ModalHeader, ModalBody, ModalFooter, useDisclosure, Input } from "@nextui-org/react";
                    ...
                    <Card key={taskItem.task?.idTask}>
                        ...
                        >
                            <div className="p-4">
                                ...
                                <p>{taskItem.task?.taskStatesIdTaskState?.description!}</p>
                            </div>
