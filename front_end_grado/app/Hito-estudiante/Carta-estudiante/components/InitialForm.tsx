...
import { Card, CardBody, CardFooter, CardHeader, Chip, Divider, Link, Image } from "@nextui-org/react";
import { FaCheck, FaTimes, FaEdit, FaEnvelope } from 'react-icons/fa';
        ...
        return (
            <div className="mt-10">
                ...
                <div className="p-2">
                    ...
                    <i><p>Utiliza el siguiente <b><Link href="https://drive.google.com/file/d/1KFDUyNch5uzvNkDF8NAu3CZXuHUQ4JZ6/view?usp=sharing" target="_blank">documento</Link></b> como ejemplo</p></i>
                </div>
        ...
        return (
            <>
                ...
                <div className="flex justify-center">
                    <Card className="" >
                        <CardHeader className={`pb-0 pt-2 px-4 flex-col items-center bg-custom-blue`}>
                            <p className="text-tiny  italic">
                            Puedes modificar tu carta
                            </p>
                            <h4 className="font-bold text-large">
                            Debes enviar tu carta
                            </h4>
                        </CardHeader>
                        <Divider />
                        <CardBody className="overflow-visible py-2">
                            ...
                            <div className="flex justify-center mt-4">
                                <Chip color="default"><Link href="https://drive.google.com/file/d/1KFDUyNch5uzvNkDF8NAu3CZXuHUQ4JZ6/view?usp=sharing" target="_blank">Carta de ejemplo</Link></Chip>
                            </div>
                            <div className="flex justify-center mt-4">
                                <Chip className="bg-custom-blue"><Link href={milestoneItem.url} target="_blank"><FaEnvelope />Tu carta<FaEnvelope /></Link></Chip>
                            </div>
                        </CardBody>
                        <Divider />
