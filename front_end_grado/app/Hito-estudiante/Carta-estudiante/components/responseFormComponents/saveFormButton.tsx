...
import { Modal, ModalContent, ModalHeader, ModalBody, ModalFooter, Button, useDisclosure, Input, Textarea, Divider } from "@nextui-org/react";
    ...
    return (
        <>
            ...
            <Modal backdrop="blur" isOpen={isOpen} size="xs">
                <ModalContent>
                    <ModalHeader className="flex flex-col gap-1">Modificar url de carta</ModalHeader>
                    <Divider />
                    <ModalBody>
                    ...
                    <Divider />
                    <ModalFooter>
                        <Button color="danger" variant="ghost" onPress={() => { onClose(); setUrl(milestoneItem.url) }} startContent={<FaTimes />}>
                            NO
                        </Button>
                        <Button color="success" variant="ghost" onClick={async () => { saveForm() }} startContent={<FaCheck />}>
                            SI
                        </Button>
                    </ModalFooter>
                </ModalContent>
