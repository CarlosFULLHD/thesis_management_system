    ...
    return (
        <>
            ...
            <div className="flex justify-center">
                <Card className={colorsMap.get(milestoneItem.taskStatesIdTaskState.idTaskState)![0]} >
                    ...
                    <CardBody className="overflow-visible py-2">
                        <div className="flex justify-center">
                            <Chip variant="shadow"><Link href={milestoneItem.url} target="_blank"><FaEnvelope />Tu carta<FaEnvelope /></Link></Chip>
                        </div>
                        ...
                        {milestoneItem.meetingDate && milestoneItem.taskStatesIdTaskState.idTaskState != 1 && (
                    ...
                    {milestoneItem.taskStatesIdTaskState.idTaskState == 2
                        ...
                        ? <> <Divider /><CardFooter className="flex justify-center mt-4 py-2">
                     ...
                     {milestoneItem.taskStatesIdTaskState.idTaskState == 4 && (
                            <div className="flex flex-col items-center p-4"> 
                                ...
                                <Button onPress={() => router.push("/Perfil-grado/Estudiante")}>Ir a perfil de grado</Button>
                            </div>
                        )
