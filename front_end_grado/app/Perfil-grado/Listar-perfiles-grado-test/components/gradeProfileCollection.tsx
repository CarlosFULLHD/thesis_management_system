...
const GradeProfileLecturerCollection = (): ReactElement | null => {
  ...
  // Error state
  if (isError || !gradeProfileLecturerList) {
    return <div>Oops! Something went wrong</div>;
  }
  // Success state
  if (gradeProfileLecturerList.length > 0) {
    return <div>No active grade profiles found.</div>;
  }
          ...
          <Card className="max-w-[500px]" key={item.gradeProfile.idGradePro}>
            ...
            <CardBody>
              ...
              <div className="grid grid-cols-3 gap-2 border border-gray-300 rounded p-4">
                <GraduationButton
                  isDisabled={
                    item.gradeProfile.statusGraduationMode == -1 ? false : true
                  }
                  idGradePro={item.gradeProfile.idGradePro}
                />
                <div className="col-span-2 flex flex-col justify-center items-start">
