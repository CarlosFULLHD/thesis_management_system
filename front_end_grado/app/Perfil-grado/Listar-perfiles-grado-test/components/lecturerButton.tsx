...
import { CircularProgress, Divider, Select, SelectItem } from "@nextui-org/react";
...
const LecturerButton = ({ isDisabled, idGradePro }: LecturerButtonProps) => {
    ...
    const assignLecturer = async () => {
        var flag : boolean = await assignTutorOrLecturerToGradeProfile(parseInt(value),idGradePro,true);
        if (!flag){
                        ...
                        {(onClose) => (
                            <>
                                ...
                                <ModalBody>
                                    ...
                                    >
                                        {(gradList) => <SelectItem key={gradList.idRolePer}>{gradList.name}</SelectItem>}
                                    </Select>
                                </ModalBody>
                                <Divider />
                                <ModalFooter>
                                    ...
                                    <Button color="success" variant="ghost" startContent={<FaPlusCircle />} onClick={() => {assignLecturer() }}>
                                        Asignar
                                    </Button>
                                </ModalFooter>
                            </>
