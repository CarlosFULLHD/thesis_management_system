...
const DateTimePickerHtml: React.FC<DateTimePickerProps> = ({
  title = "",
  onChange,
  dateValue,
  bgColorClass = "bg-red",
  fontColorClass = "text-gray-500",
}) => {
  ...
  return (
    <>
      ...
      <input
        className={`appearance-none shadow py-3 px-2 rounded-lg ${fontColorClass} ${bgColorClass}`}
        type="datetime-local"
        id="meeting-time"
        name="meeting-time"
        value={meetingTime}
